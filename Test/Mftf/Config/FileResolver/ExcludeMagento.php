...
namespace Mageproxy\Connector\Test\Mftf\Config\FileResolver;
 ...
 */
class ExcludeMagento implements FileResolverInterface
{
    /**
    ...
    protected function getFileCollection($filename, $scope)
    {
        ...
        $modulesPath = array_filter(
            $modulesPath,
            function ($path) {
                return strpos($path, 'vendor/magento') === false;
            }
        );
